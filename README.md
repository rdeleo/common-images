...
You can find: 
- The latest supported versions of php: 7.2.31, 7.3.18, 7.4.6
...
#### CentOS7 Php7.4 Cli: 7.4.6

This is the very base container, with only CentOS 7 and Php 7.4.6. 

The easiest way to test this container is to run one in your local machine, you can use the following command:
```bash
docker run --rm rdeleo/centos7-php7.4-cli:7.4.6 php -v
```

#### CentOS7 Php7.4 Utils: 7.4.6

This is the utils container, with CentOS 7, Php 7.4.6, composer and prestissimo.

The easiest way to test this container is to run one in your local machine, you can use the following command:

```bash
docker run --rm rdeleo/centos7-php7.4-cli:7.4.6 composer -v
```

#### CentOS7 Php7.4 Apache Dev: 7.4.6

This is the development container, with CentOS 7, Php 7.4.6, Apache 2.4.6 and XDebug.
...
#### CentOS7 Php7.4 Apache Prod: 7.4.6

This is the production container, with CentOS 7, Php 7.4.6, Apache 2.4.6 and Certbot to manage a grade A+ (tested with https://www.ssllabs.com/ on the 2020-01-16) SSL certificate.
...
#### CentOS7 Php7.3 Cli: 7.3.18

This is the very base container, with only CentOS 7 and Php 7.3.18. 

The easiest way to test this container is to run one in your local machine, you can use the following command:
```bash
docker run --rm rdeleo/centos7-php7.3-cli:7.3.18 php -v
```

#### CentOS7 Php7.3 Utils: 7.3.18

This is the utils container, with CentOS 7, Php 7.3.18, composer and prestissimo.

The easiest way to test this container is to run one in your local machine, you can use the following command:

```bash
docker run --rm rdeleo/centos7-php7.3-cli:7.3.18 composer -v
```

#### CentOS7 Php7.3 Apache Dev: 7.3.18

This is the development container, with CentOS 7, Php 7.3.18, Apache 2.4.6 and XDebug.
...
#### CentOS7 Php7.3 Apache Prod: 7.3.18

This is the production container, with CentOS 7, Php 7.3.18, Apache 2.4.6 and Certbot to manage a grade A+ (tested with https://www.ssllabs.com/ on the 2020-01-16) SSL certificate.
...
#### CentOS8 Php7.4 Cli: 7.4.6

This is the very base container, with only CentOS 8 and Php 7.4.6. Although httpd apache 2.4.37 is installed, is not started. 

The easiest way to test this container is to run one in your local machine, you can use the following command:
```bash
docker run --rm rdeleo/centos8-php7.4-cli:7.4.6 php -v
```

#### CentOS8 Php7.4 Utils: 7.4.6

This is the utils container, with CentOS 8, Php 7.4.6, composer and prestissimo.

The easiest way to test this container is to run one in your local machine, you can use the following command:

```bash
docker run --rm rdeleo/centos8-php7.4-cli:7.4.6 composer -v
```

#### CentOS8 Php7.4 Apache Dev: 7.4.6

This is the development container, with CentOS 8, Php 7.4.6, Apache 2.4.6 and XDebug.
...
#### Debian10 Php7.4 Cli: 7.4.6

This is the very base container, with only Debian 10 and Php 7.4.6.

The easiest way to test this container is to run one in your local machine, you can use the following command:
```bash
docker run --rm rdeleo/debian10-php7.4-cli:7.4.6 php -v
```

#### Debian10 Php7.4 Utils: 7.4.6

This is the utils container, with Debian 10, Php 7.4.6, composer and prestissimo.

The easiest way to test this container is to run one in your local machine, you can use the following command:

```bash
docker run --rm rdeleo/debian10-php7.4-utils:7.4.6 composer -v
```

#### Debian10 Php7.4 Apache Dev: 7.4.6

This is the development container, with Debian 10, Php 7.4.6, Apache 2.4.38 and XDebug.
...
#### Debian10 Php7.4 Apache Prod: 7.4.6

This is the production container, with Debian 10, Php 7.4.6, Apache 2.4.38 and Certbot to manage a grade A (tested with https://www.ssllabs.com/ on the 2020-01-16) SSL certificate.
...
#### Debian10 Php7.3 Cli: 7.3.18

This is the very base container, with only Debian 10 and Php 7.3.18.

The easiest way to test this container is to run one in your local machine, you can use the following command:
```bash
docker run --rm rdeleo/debian10-php7.3-cli:7.3.18 php -v
```

#### Debian10 Php7.3 Utils: 7.3.18

This is the utils container, with Debian 10, Php 7.3.18, composer and prestissimo.

The easiest way to test this container is to run one in your local machine, you can use the following command:

```bash
docker run --rm rdeleo/debian10-php7.3-utils:7.3.18 composer -v
```

#### Debian10 Php7.3 Apache Dev: 7.3.18

This is the development container, with Debian 10, Php 7.3.18, Apache 2.4.38 and XDebug.
...
#### Debian10 Php7.3 Apache Prod: 7.3.18

This is the production container, with Debian 7, Php 7.3.18, Apache 2.4.38 and Certbot to manage a grade A (tested with https://www.ssllabs.com/ on the 2020-01-16) SSL certificate.
